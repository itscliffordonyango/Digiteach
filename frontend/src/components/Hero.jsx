        ...
        <div className="hero-left">
          ...
          <div className="hero-buttons">
            <a href="#" className="hero-btn primary">
              Explore DigiTeach <i className="fa-solid fa-arrow-right ms-2" aria-hidden="true" />
            </a>
      ...
      <div className="programme-card-section container">
        <div className="programme-card">
          <div className="programme-left">
            ...
            <br />
            <h2 style={{ fontSize: 40 }}>DigiTeach</h2>
          </div>
          ...
          <div className="programme-right">
            <a href="#" className="programme-btn">
              See what Teachers Learn <i className="fa-solid fa-arrow-right" aria-hidden="true" />
            </a>
          </div>
        </div>
      </div>
